...
**Windows:**
```bash
Double-click: RUN_WITH_API_FETCH.bat
```
...
3. ✅ Creates `user_names.json` automatically
4. ✅ Saves export file
5. ✅ Runs analysis
6. ✅ Opens dashboard
...
3. **Set Program**
   - Program: `C:\Path\To\RUN_WITH_API_FETCH.bat`
...
3. Test with `RUN_WITH_API_FETCH.bat`

**Daily Use:**
1. Double-click `RUN_WITH_API_FETCH.bat`
...
- [ ] Tested `RUN_WITH_API_FETCH.bat`
- [ ] Verified user_names.json created
...
- **On-Demand:** Double-click `RUN_WITH_API_FETCH.bat`
...
**For script issues:**
1. Check `API_SETUP_GUIDE.md` (this file)
