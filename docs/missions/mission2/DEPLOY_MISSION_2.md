...
- ✅ **Mission design document:** `docs/MISSION_2_CIPHER_BREAKER.md`
- ✅ **Ready-to-paste system prompt:** `docs/mission-2-system-prompt.txt`
...
Open: `docs/mission-2-system-prompt.txt`
...
| **System Prompt** | *Paste from `docs/mission-2-system-prompt.txt`* |
...
| File | Purpose |
|------|---------|
| `docs/MISSION_2_CIPHER_BREAKER.md` | Complete mission documentation |
| `docs/mission-2-system-prompt.txt` | **Copy this to OpenWebUI** |
...
```bash
1. Open: docs/mission-2-system-prompt.txt
2. Copy all text
