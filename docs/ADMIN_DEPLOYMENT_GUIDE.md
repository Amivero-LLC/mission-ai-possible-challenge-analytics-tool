...
2. **Files to Include:**
   ...
   ├── scripts/RUN_ANALYSIS.bat  ← Admins double-click this
   ├── analyze_missions.py
   ├── mission_analyzer.py
...
1. **Upload to SharePoint Document Library**
  ...
  - Upload scripts/RUN_ANALYSIS.bat
...
2. **Admin Workflow:**
   ...
   3. Drop export file
   4. Double-click scripts/RUN_ANALYSIS.bat
   5. View dashboard
   ```
...
# Manually open
1. Run the analysis
2. Open: public/mission_dashboard.html in browser
```
